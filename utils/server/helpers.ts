...
import { IUpdateCommentScoreArgs } from "../../models/server/comments";
import { Direction } from "../../models/server/enums";
import { IUpdatePostScoreArgs } from "../../models/server/posts";
